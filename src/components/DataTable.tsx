...
function DataTable() {
    ...
    //TODO: write useGetData hook and selection model state change content, aka make selection boxes work
    ...
    <>
        ...
        >
            <h2 className='h-3 bg-slate-300 my-2 rounded'>My Contacts</h2>
